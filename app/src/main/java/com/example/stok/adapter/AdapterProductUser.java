...
import com.example.stok.FilterProductUser;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        //fungsi decrement hanya kuantitas lebih dari 1
        decrementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (quantity>1){
                    ...
                    finalPriceTv.setText("Rp"+finalCost);
                    quantityTv.setText("Rp"+quantity);
                }
            }
        });
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String totalPrice = finalPriceTv.getText().toString().trim().replace("Rp","");
