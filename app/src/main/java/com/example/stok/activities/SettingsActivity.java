...
public class SettingsActivity extends AppCompatActivity {
     ...
     private static final String enabledMessage = "Notifikasi Di Aktifkan";
     private static final String disabledMessage = "Notifikasi Di Nonaktifkan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //add option in main user activity
    ...
    private void unSubscribeToTopic(){
        FirebaseMessaging.getInstance().unsubscribeFromTopic(Constans.FCM_TOPIC)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        //un subcribe
